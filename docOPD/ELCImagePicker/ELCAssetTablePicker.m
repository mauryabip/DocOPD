...
- (void)viewDidLoad
{
    self.columns = kELCAssetTablePickerColumns; //Add this line by ashutosh
...
//    self.columns = self.view.bounds.size.width / 80; //Ashutosh
...
//        self.columns = 4; //ashutosh
        self.columns = kELCAssetTablePickerColumns;
    }
//    NSInteger numRows = ceil([self.elcAssets count] / (float)self.columns);  //ashutosh
//    return numRows; //ashutosh
...
{    
    ...
    cell.itemPadding = kELCAssetCellPadding;  //add this ashutosh
    cell.numberOfColumns = self.columns; //add this ashutosh
