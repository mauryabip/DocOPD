...
//        self.leftTableview.frame = CGRectMake(0, 0, kScreenWidth - kMainPageDistance, kScreenHeight);
         self.leftTableview.frame = CGRectMake(0, 120, kScreenWidth - kMainPageDistance, kScreenHeight);
...
//        self.leftTableview.center = CGPointMake(kLeftCenterX, kScreenHeight * 0.5);
        self.leftTableview.frame = CGRectMake(0, 125, kScreenWidth, kScreenHeight);
...
//        self.leftTableview.center = CGPointMake(leftTabCenterX, kScreenHeight * 0.5);
         self.leftTableview.frame = CGRectMake(0, 125, kScreenWidth - kMainPageDistance, kScreenHeight);
...
//    self.leftTableview.transform = CGAffineTransformScale(CGAffineTransformIdentity,1.0,1.0);//Ashutosh
