...
- (void) didTap:(MHFacebookImageViewerTapGestureRecognizer*)gestureRecognizer {
    ...
    [[self imageBrowser] setCaptionTexts:gestureRecognizer.captionText];
    if(self.image)
...
/*==========================================================================================================================================
                                        Custom function for the caption show
========================================================================================================================================== */
- (void) setupImageViewerWithText:(NSString *)text {
    [self setupImageViewerWithCompletionOnOpen:nil onClose:nil withCaptionText:text];
}

- (void) setupImageViewerWithCompletionOnOpen:(MHFacebookImageViewerOpeningBlock)open onClose:(MHFacebookImageViewerClosingBlock)close withCaptionText:(NSString*)text{
    [self setupImageViewerWithImageURL:nil onOpen:open onClose:close withCaptionText:text];
}


- (void) setupImageViewerWithImageURL:(NSURL *)url onOpen:(MHFacebookImageViewerOpeningBlock)open onClose:(MHFacebookImageViewerClosingBlock)close withCaptionText:(NSString*)text{
    self.userInteractionEnabled = YES;
    MHFacebookImageViewerTapGestureRecognizer *  tapGesture = [[MHFacebookImageViewerTapGestureRecognizer alloc] initWithTarget:self action:@selector(didTaps:)];
    tapGesture.imageURL = url;
    tapGesture.openingBlock = open;
    tapGesture.closingBlock = close;
    tapGesture.captionText = text;
    [self addGestureRecognizer:tapGesture];
    tapGesture = nil;
}

- (void) didTaps:(MHFacebookImageViewerTapGestureRecognizer*)gestureRecognizer{
