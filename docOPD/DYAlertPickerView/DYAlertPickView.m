...
@property NSString *textforselect;
@end
...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor dOPDThemeColor];
        ...
        self.cancelButtonBackgroundColor = [UIColor colorWithRed:56.0/255 green:185.0/255 blue:158.0/255 alpha:1];
//[UIColor colorWithRed:255.0/255 green:71.0/255.0 blue:25.0/255 alpha:1];
...
//    }
    ...
    NSString *stringToSelect = [self.dataSource stringForSelection:self stringForMatch:indexPath.row];
    if ([stringToSelect isEqualToString:cell.textLabel.text]) {
        cell.accessoryType = UITableViewCellAccessoryCheckmark;
