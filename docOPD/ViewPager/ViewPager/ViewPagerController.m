...
- (void)layoutSubviews
{
    UIView *topbar = [[UIView alloc]initWithFrame:CGRectMake(0, 20, [UIScreen mainScreen].bounds.size.width, 44)];
    topbar.backgroundColor = [UIColor dOPDThemeColor];
    [self.view addSubview:topbar];
    
    UILabel *lblTitle =[[UILabel alloc]initWithFrame:CGRectMake(0, 0, topbar.frame.size.width, 44)];
    ...
    UIImageView*btnimg= [[UIImageView alloc]initWithFrame:CGRectMake(10, 9, 23, 23)];
    btnimg.image = [UIImage imageNamed:@"menu.png"];
    [topbar addSubview: btnimg];
...
//    frame.origin.y = self.tabLocation == ViewPagerTabLocationTop ? topLayoutGuide : CGRectGetHeight(self.view.frame) - self.tabHeight;
       frame.origin.y = topbar.frame.origin.y + topbar.frame.size.height+1;
